...
public class ResultSorterTest
{
    ...
    private RaceResult resultBoat1 = new RaceResult(
            null, testBoat1, 1, new Date(), new Date(), ResultStatus.FINISHED,90,90,0,0);
    private RaceResult resultBoat2 = new RaceResult(
            null, testBoat2, 1, new Date(), new Date(), ResultStatus.FINISHED,100,85,0,0);
    private RaceResult resultBoat3 = new RaceResult(
            null, testBoat3, 1, new Date(), new Date(), ResultStatus.FINISHED,95,94,0,0);
    private RaceResult resultNonStarter1 = new RaceResult(
            null, testNonStarter1, 1, new Date(), new Date(), ResultStatus.DNS);
    private RaceResult resultNonStarter2 = new RaceResult(
            null, testNonStarter2, 1, new Date(), new Date(), ResultStatus.DNC);
